...
PluginBundleActionDelegate::PluginBundleActionDelegate(QObject* parent) : QStyledItemDelegate(parent) {}

QRect
PluginBundleActionDelegate::actionButtonRect(QRect const& cell)
{
    return cell.adjusted(kMargin, 2, -kMargin, -2);
}

void
PluginBundleActionDelegate::drawActionButton(QPainter* painter,
                                             QRect const& rect,
                                             QString const& text,
...
void
PluginBundleActionDelegate::paint(QPainter* painter, QStyleOptionViewItem const& option, QModelIndex const& index) const
{
    ...
    QRect const btnRect = actionButtonRect(option.rect);
...
QSize
PluginBundleActionDelegate::sizeHint(QStyleOptionViewItem const& option, QModelIndex const& index) const
{
    Q_UNUSED(option);
    Q_UNUSED(index);
    return QSize(80, 28);
...
bool
PluginBundleActionDelegate::editorEvent(QEvent* event,
